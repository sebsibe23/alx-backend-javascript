/**
 * Unit tests for the calculateNumber function using Mocha and Chai.
 *
 * This script uses the expect function from the Chai library to validate
 * the correctness of the calculateNumber function, ensuring it correctly
 * rounds and performs arithmetic operations on the input numbers based
